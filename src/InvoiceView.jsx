...
function InvoiceView() {
    ...
    return (
        <div className="relative h-full">
            ...
            <main className={`pt-8 h-full md:pb-32 xl:px-64 xl:py-16 ${theme === "light" ? "light2" : "dark2"} ${confirmDelete ? "brightness-50" : ""}`} >
                <div className='mx-6 md:mx-10'>
                    <BackBtn />
                </div>
                <div className={`${theme === "light" ? "light4" : "dark4"} flex justify-between p-6 rounded-md items-center mb-4 mx-6 md:mx-10 md:px-8 xl:mb-6`}>
                ...
                <div className={`${theme === "light" ? "light4" : "dark4"} p-6 rounded-md mb-14 mx-6 md:mx-10 md:px-8 xl:p-12`}>
                    <div className='md:flex md:justify-between xl:mb-5'>
                        <div>
