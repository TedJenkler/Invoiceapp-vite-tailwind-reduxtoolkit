      ...
      <section className='px-6 flex flex-col md:px-14 xl:px-60'>
          ...
          <div className='flex flex-col md:flex-row gap-4 md:w-full'>
            ...
            <div className='flex flex-col w-full md:w-1/3'>
              ...
              <input
                ...
                value={country2}
                className={`${theme === "light" ? 'light4' : 'dark4'} ${errorCountry2 ? "outline outline-red" : "outline-none"} border border-${theme === "light" ? "05" : "03"} w-full h-12 rounded px-5`}
              />
            </div>
          </div>
        </div>
        <div className='flex flex-col md:flex-row md:gap-4'>
          <div className='flex flex-col md:w-1/2'>
            ...
            <input onChange={(e) => setDate(e.target.value)} value={date} className={`${theme === "light" ? 'light4' : 'dark4'} border border-${theme === "light" ? "05" : "03"} h-12 rounded mb-6 px-5`} type='date' />
          </div>
          <div className='flex flex-col md:w-1/2'>
